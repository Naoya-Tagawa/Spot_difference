...
def index(request):
    ...
    if (request.method == 'POST'):
        ...
        print(params['url'])
    return render(request,'apps/home.html',params)
...
def preview(request,image_id):
    ...
    print(params['url'])
    return render(request, 'apps/preview.html', params)
...
def transform(request, image_id=0):
    ...
    if (request.method == 'POST'):
        ...
        if form.is_valid():
            ...
            return render(request, 'apps/transform.html', params)
...
def input_form(request):
    ...
    if (request.method == 'POST'):
        ...
        #print(params['id'])
    return render(request,'apps/find.html',params)
...
def delete(request,image_id):
    ...
    return render(request,'apps/delete_img.html')
